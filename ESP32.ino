...
const char* mqtt_server = "projetoifsc.dtdns.org"; // domínio cadastrado no DTDNS pra poder usar em qualquer lugar com o IP dinâmico em casa, onde está a Raspberry
...
const String VERSION = "<p> Versão 1.14 teste para acessar o broker MQTT fora da conexão local </p>"; // Exemplo de um controle de versão
